...
*/
  var CoordCache = (FC.CoordCache = Class.extend({
    ...
    build: function () {
      var offsetParentEl =
        this.forcedOffsetParentEl || this.els.eq(0).offsetParent();
    ...
    buildSegDragListener: function (seg) {
      ...
      var dragListener = (this.segDragListener = new HitDragListener(view, {
        ...
        hitOver: function (hit, isOrig, origHit) {
          ...
          if (
            dropLocation &&
            !calendar.isEventSpanAllowed(_this.eventToSpan(dropLocation), event)
          ) {
            disableCursor();
            dropLocation = null;
          }
  ...
  var View = (FC.View = Class.extend(EmitterMixin, ListenerMixin, {
    ...
    display: function (date, explicitScrollState) {
      ...
      return syncThen(this.clear(), function () {
        ...
        return (_this.displaying = syncThen(
          _this.displayView(date),
          function () {
  ...
  function Calendar_constructor(element, overrides) {
    ...
    t.humanizeDuration = function (duration) {
      return (duration.locale || duration.lang)
        .call(duration, t.options.lang) // works moment-pre-2.8
        .humanize();
    };
        ...
        $.each(buttonStr.split(" "), function (i) {
          ...
          $.each(this.split(","), function (j, buttonName) {
            ...
            if (buttonName == "title") {
              ...
              if (
                (customButtonProps = (options.customButtons || {})[buttonName])
              ) {
...
(function (e) {
  var a = [],
    ...
    b =
      !!window.createPopup &&
      document.documentElement.currentStyle.minWidth == "undefined";
  function f() {
    e.each(a, function () {
      this.refresh(true);
    });
  ...
  e.Poshytip.prototype = {
    init: function () {
      ...
      this.$elm
        .data("title.poshytip", g !== undefined ? g : null)
        .data("poshytip", this);
        ...
        switch (this.opts.showOn) {
          case "hover":
            if (this.opts.alignTo == "cursor") {
              this.$elm.bind(
                "mousemove.poshytip",
                e.proxy(this.mousemove, this)
              );
            }
            if (this.opts.allowTipHover) {
              this.$tip.hover(
                e.proxy(this.clearTimeouts, this),
      ...
      if (
        ...
        (this.asyncAnimating &&
          (this.$tip[0] === g.relatedTarget ||
            jQuery.contains(this.$tip[0], g.relatedTarget)))
      ) {
        return true;
      }
    ...
    showDelayed: function (g) {
      ...
      this.showTimeout = setTimeout(
        ...
        typeof g == "number" ? g : this.opts.showTimeout
      );
    },
    hide: function () {
      if (this.disabled || !this.$tip.data("active")) {
    ...
    hideDelayed: function (g) {
      ...
      this.hideTimeout = setTimeout(
        ...
        typeof g == "number" ? g : this.opts.hideTimeout
      );
    },
    reset: function () {
      this.$tip
    ...
    update: function (j, k) {
      ...
      var h = this,
        g =
          typeof j == "function"
            ? j.call(this.$elm[0], function (l) {
                h.update(l);
              })
            : j == "[title]"
            ? this.$elm.data("title.poshytip")
            : j;
      if (this.content !== g) {
          ...
          o.width("auto")
            ...
            .width(
              (document.defaultView &&
                ...
                parseFloat(
                  document.defaultView.getComputedStyle(this.$tip[0], null)
                    .width
                )) ||
                this.$tip.width()
            )
    ...
    display: function (h) {
      ...
      if (
        ...
        ((h && this.opts.hideAniDuration) || (!h && this.opts.showAniDuration))
      ) {
        var n = {},
          m = {};
        ...
        this.$tip
          .css(n)
          .animate(m, this.opts[h ? "hideAniDuration" : "showAniDuration"]);
      }
      h
        ? this.$tip.queue(e.proxy(this.reset, this))
    ...
    if (typeof h == "string") {
      ...
      if (l == "destroy") {
        this.die
          ...
          : e(document)
              .undelegate(this.selector, "mouseenter.poshytip")
              .undelegate(this.selector, "focus.poshytip");
      }
    ...
    if (j.liveEvents && j.showOn != "none") {
      ...
      switch (j.showOn) {
        case "hover":
          ...
          this.live
            ? this.live("mouseenter.poshytip", i)
            : e(document).delegate(this.selector, "mouseenter.poshytip", i);
          break;
        case "focus":
          i = function () {
            var m = e(this);
          ...
          this.live
            ? this.live("focus.poshytip", i)
            : e(document).delegate(this.selector, "focus.poshytip", i);
          break;
      }
      return this;
    }
