<?php
	$_dep = array(3,1,1);
	$_tit = array('DOCS','세팅 가이드','html 세팅 가이드');
  $_docs = true;
...
<div class="groupWrap setting">
  ...
  <section class="group">
    ...
    <div class="codeBox">
      <code id="myGit">git clone https://github.com/velocista7/html_setting.git</code>
  ...
  <section class="group">
    <div class="title">
      <h5>CSR html Setting TREE</h5>
    </div>
    <div class="treeBox">
      <ul class="tree">
        <li>
          <input type="checkbox" checked="checked" id="c1" />
          <label class="tree_label" for="c1">html_setting</label>
          <ul>
            <li>
            ...
            <li>
              ...
              <ul>
                <li><span class="tree_label">PAGES_0000.html <em>코딩 리스트와 링크 연동을 위해 id 일치시켜야 함 ex)WBS_ID 'PAGES_0000'</em></span></li>
              </ul>
            </li>
            <li><span class="tree_label">index.html <em>코딩 리스트로 리다이렉션 (메인페이지로 사용해도 무방)</em></span></li>
          </ul>          
        </li>
      </ul>
    </div>
